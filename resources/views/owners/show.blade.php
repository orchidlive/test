...
<div class="mt-4 flex flex-row">
    <a href="{{route('owner.edit', $owner)}}" class="shadow bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded">
        Edit Owner
    </a>
</div>
@endsection
